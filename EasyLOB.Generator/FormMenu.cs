...
namespace EasyLOB.Generator
{
    public partial class FormMenu : Form
    {
        public FormMenu()
        {
            ...
            #if DEBUG
            // EasyLOB-Generator\bin\Debug\..\..\..\EasyLOB-MyLOB-2
            string templateDirectory = Path.Combine(Directory.GetParent(Path.Combine(exeDirectory, "..\\..\\..")).FullName, "EasyLOB-MyLOB-2");
            #else
            // EasyLOB-Generator\..\EasyLOB-MyLOB-2
            string templateDirectory = Path.Combine(Directory.GetParent(exeDirectory).FullName, "EasyLOB-MyLOB-2");
            #endif
        ...
        private void lbllnkEasyLOB_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            System.Diagnostics.Process.Start("https://github.com/EasyLOB/EasyLOB-2/wiki");
        }
